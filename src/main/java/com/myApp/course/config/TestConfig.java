...
import com.myApp.course.entities.OrderItem;
import com.myApp.course.entities.Payment;
...
import com.myApp.course.repositories.OrderItemRepository;
import com.myApp.course.repositories.OrderRepository;
import com.myApp.course.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		productRepository.saveAll(Arrays.asList(p1,p2,p3,p4,p5));
		Payment pay1 = new Payment(null,Instant.parse("2022-12-25T21:53:07Z"), o1);
		o1.setPayment(pay1);
